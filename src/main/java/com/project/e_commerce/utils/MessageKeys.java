...
public class MessageKeys {
    ...
    public static final String OTP_SENT_SUCCESSFULLY = "otp.send_otp.success";
    public static final String OTP_VERIFIED_SUCCESSFULLY = "otp.verify_otp.success";
    public static final String OTP_VERIFICATION_FAILED = "otp.verify_otp.failed";
    public static final String OTP_EXPIRED = "otp.verify_otp.expired";
    public static final String OTP_ALREADY_VERIFIED = "otp.verify_otp.already_verified";
    public static final String OTP_NOT_FOUND = "otp.verify_otp.not_found";
